...
# Import the base pipeline infrastructure
...
class FuelPipeline(PipelineBase):
    """
    An OpenCV pipeline for fuel detection, integrated with the pipeline framework.
    Originally generated by GRIP.
    """
    
    name = "fuel"  # Pipeline registry name
    
    def __init__(self, camera):
        """Initialize the fuel detection pipeline.
        
        Args:
            camera: RealSenseCamera instance for frame capture
    ...
    def iterate(self):
        ...
        # Run the GRIP pipeline processing
    ...
    def get_color_jpeg(self) -> Optional[bytes]:
        ...
        if self._color_frame is None:
            return None
        return frames_to_jpeg_bytes(self._color_frame)
